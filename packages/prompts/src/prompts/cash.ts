    ...
    versions: [
      {
        ...
        template:
          ...
          "- Use `view_kassenbericht` when the user asks to open or view the report. Do not use it merely because the user asks a question about Kassenbericht terminology. Do not use it when the user asks to create or finalize a Kassenbericht. Pass an explicit date when the user names one. Omit the date when the current daily workspace date should be used.\n",
