...
export class DEPackV1 extends TaxJurisdictionPack {
  ...
  private async applyStandardVat(
    ...
    for (const line of lineResults) {
      ...
      totalsByKind[line.kind].netAmountCents += line.netAmountCents;
      totalsByKind[line.kind].taxAmountCents += line.taxAmountCents;
      totalsByKind[line.kind].grossAmountCents += line.grossAmountCents;
    }
