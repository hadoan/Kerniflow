...
export default function OpenShiftScreen() {
  ...
  const handleOpenShift = async () => {
    const startingCashCents = startingCash
      ? Math.round(parseFloat(startingCash) * 100)
      : null;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Start a new shift to begin selling. Enter the starting cash amount in
          the register drawer (optional).
        </Text>
        ...
        <View style={styles.form}>
          ...
          <Text style={styles.hint}>
            This helps track cash variance at the end of your shift
          </Text>
        </View>
