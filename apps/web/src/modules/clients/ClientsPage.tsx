  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <Button variant="accent"><Plus className="h-4 w-4" />{t('clients.addClient')}</Button>
      </div>

      {clients?.length === 0 ? (
        <EmptyState icon={Users} title={t('clients.noClients')} description={t('clients.noClientsDescription')} />
      ) : (
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-foreground truncate">{client.company || client.name}</h3>
