    ...
    navItems: [
      {
        ...
        labelKey: "nav.inventoryProducts",
        icon: Package,
        path: "/inventory/products",
      },
      {
        id: "inventory-warehouses",
        labelKey: "nav.inventoryWarehouses",
        icon: FolderKanban,
      ...
      },
      {
        ...
        labelKey: "nav.inventoryDocuments",
        icon: FileStack,
        path: "/inventory/documents",
      },
      {
        id: "inventory-reorder",
        labelKey: "nav.inventoryReorder",
        icon: ShoppingCart,
        path: "/inventory/reorder",
      },
      {
        id: "inventory-copilot",
        labelKey: "nav.inventoryCopilot",
        icon: Sparkles,
