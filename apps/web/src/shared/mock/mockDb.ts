import type { 
  Tenant, User, Client, Project, Expense, Invoice, 
  Conversation, ChatMessage, ExpenseCategory, VatRate, InvoiceStatus 
} from '../types';
...
const seedInvoices: Invoice[] = [
  {
    ...
    items: [
      { id: 'item-1', description: 'Website design consulting', quantity: 20, unitPriceCents: 9500, vatRate: 19, totalCents: 190000 },
      { id: 'item-2', description: 'UI/UX wireframes', quantity: 1, unitPriceCents: 150000, vatRate: 19, totalCents: 150000 },
    ],
  ...
  },
  {
    ...
    items: [
      { id: 'item-3', description: 'Brand strategy workshop', quantity: 8, unitPriceCents: 12000, vatRate: 19, totalCents: 96000 },
      { id: 'item-4', description: 'Logo design (3 concepts)', quantity: 1, unitPriceCents: 250000, vatRate: 19, totalCents: 250000 },
    ],
  ...
  },
  {
    ...
    items: [
      { id: 'item-5', description: 'Social media strategy - October', quantity: 1, unitPriceCents: 200000, vatRate: 19, totalCents: 200000 },
    ],
  ...
  },
  {
    ...
    items: [
      { id: 'item-6', description: 'Website development - Phase 1', quantity: 40, unitPriceCents: 9500, vatRate: 19, totalCents: 380000 },
    ],
  ...
  },
  {
    ...
    items: [
      { id: 'item-7', description: 'Brand guidelines document', quantity: 1, unitPriceCents: 180000, vatRate: 19, totalCents: 180000 },
      { id: 'item-8', description: 'Asset library creation', quantity: 1, unitPriceCents: 120000, vatRate: 19, totalCents: 120000 },
    ],
  ...
  },
  {
    ...
    items: [
      { id: 'item-9', description: 'Social media strategy - November', quantity: 1, unitPriceCents: 200000, vatRate: 19, totalCents: 200000 },
      { id: 'item-10', description: 'Content creation (10 posts)', quantity: 10, unitPriceCents: 15000, vatRate: 19, totalCents: 150000 },
    ],
